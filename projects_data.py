PROJECTS = {
    "bros": {
        ...
        "details": """
            ...
            <strong>Frontend</strong>는 사용자가 풍부한 지도 인터페이스를 탐색하고, 피드 시스템을 통해 타인과 소통하며, 코스메틱 아이템으로 경험을 사용자 정의할 수 있게 합니다.
            <strong>Backend</strong>는 Flask의 Blueprint 아키텍처를 기반으로 구축되어, 인증, 게시물, 장소, 결제 등 다양한 서비스 간의 모듈성을 보장합니다.
        """,
    },
    "404-ai": {
        "id": "404-ai",
    ...
    "obj-dct-seg": {
        ...
        "details": """
            ...
            <strong>YOLO (Ultralytics)</strong> 를 사용하여 불량 검사 대상 영역(ROI)을 탐지하고, <strong>Anomalib (PatchCore)</strong> 알고리즘을 통해 미세한 스크래치나 파손 같은 이상 징후를 판별합니다.
